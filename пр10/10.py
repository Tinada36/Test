...
window = Tk()
window.title("Летин Михаил Андреевич")
...
btn1 = Button(tab2, text="Нажмите на кнопку", command=clicked1)
...
btn2 = Button(tab3, text="Загузить файл", command=clicked2)
btn2.grid(row=1, column=0, pady=10)
btn3 = Button(tab3, text="Сохранить файл", command=clicked3)
